...
public interface SortedCollection<E> extends OrderedCollection<E> {
    /**
     * Returns a new sorted collection containing all the elements present in the first collection, but not in any of
     * the other provided collections.
     *
     ...
     * @return A new sorted collection containing all the elements present in the first collection, but not in any of
     *         the other provided collections.
     */
    ...
    /**
     * Returns a new sorted collection containing all the elements present in the first collection, but not in any of
     * the other provided collections, sorted the same way as the first collection.
     *
     * This method corresponds to the difference (or relative complement) operation in set theory, denoted by the symbol
     * ∖, with {1, 2, 3} ∖ {2, 3, 4} = {1}.
     *
    ...
    /**
     * Returns a new sorted collection cloned from the provided collection with the specified element cardinality.
     *
     * @param <F>                The element type.
     * @param elementCardinality The element cardinality.
     * @param comparator         The comparator by which to sort the elements.
     * @param collection         The original collection.
     * @return A new sorted collection cloned from the provided collection with the specified element cardinality.
     */
    static <F> SortedCollection<F> of(final ElementCardinality elementCardinality,
        ...
        return new SortedArrayCollection<F>(elementCardinality, comparator, collection);
    }
