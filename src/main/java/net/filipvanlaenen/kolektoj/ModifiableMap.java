...
public interface ModifiableMap<K, V> extends Collection<Entry<K, V>>, UpdatableMap<K, V> {
    /**
     * Returns a new modifiable map containing all the entries present in the first map, but not in any of the other
     * provided maps.
     *
    ...
    /**
     * Returns a new modifiable map containing all the entries present in each of the provided maps.
     *
