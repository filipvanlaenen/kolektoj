 ...
 */
abstract class DeprecatedNode<K> {
    /**
     ...
     */
    DeprecatedNode(final K sortingKey) {
     ...
     */
    private static <L> int getHeight(final DeprecatedNode<L> node) {
     ...
     */
    DeprecatedNode<K> getLeftmostChild() {
     ...
     */
    DeprecatedNode<K> getRightChild() {
        return rightChild;
    }
     ...
     */
    private static <F> int getSize(final DeprecatedNode<F> node) {
     ...
     */
    private DeprecatedNode<K> rotateLeft() {
        DeprecatedNode<K> originalRightChild = getRightChild();
     ...
     */
    private DeprecatedNode<K> rotateRight() {
        DeprecatedNode<K> originalLeftChild = getLeftChild();
     ...
     */
    void setLeftChild(final DeprecatedNode<K> leftChild) {
     ...
     */
    void setRightChild(final DeprecatedNode<K> rightChild) {
